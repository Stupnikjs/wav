...
pub export fn add(arg_x: c_int, arg_y: c_int) c_int {
    var x = arg_x;
    _ = &x;
    var y = arg_y;
    _ = &y;
    _ = printf("adding");
    return (x + y) - @as(c_int, 1);
}
...
// C:\ProgramData\chocolatey\lib\zig\tools\zig-windows-x86_64-0.13.0\lib\libc\include\any-windows-any/sec_api/stdio_s.h:16:9
