...
pub export fn create_wav() void {
    ...
    _ = &wavh;
    const MIDDLE_C: f32 = @as(f32, @floatCast(256.0));
    _ = &MIDDLE_C;
    const sample_rate: c_int = 8000;
    _ = &sample_rate;
    const duration_seconds: c_int = 14;
    _ = &duration_seconds;
    var buffer: [112000]c_short = [1]c_short{0} ** 112000;
    _ = &buffer;
    ...
    _ = &fcsv;
    {
        var i: c_int = 0;
        _ = &i;
        while (i < (sample_rate * duration_seconds)) : (i += 1) {
            ...
            _ = fwrite(@as(?*const anyopaque, @ptrCast(&buffer[@as(c_uint, @intCast(i))])), @as(c_ulonglong, @bitCast(@as(c_longlong, @as(c_int, 2)))), @as(c_ulonglong, @bitCast(@as(c_longlong, @as(c_int, 2)))), fcsv);
        }
    }
    wavh.dlength = (sample_rate * duration_seconds) * @as(c_int, @bitCast(@as(c_int, wavh.bytes_per_samp)));
    ...
    _ = fwrite(@as(?*const anyopaque, @ptrCast(@as([*c]c_short, @ptrCast(@alignCast(&buffer))))), @as(c_ulonglong, @bitCast(@as(c_longlong, @as(c_int, 2)))), @as(c_ulonglong, @bitCast(@as(c_longlong, sample_rate * duration_seconds))), fp);
}
...
pub const BUFFER_SIZE = @compileError("unable to translate macro: undefined identifier `sample_rate`");
// C:\Users\Amélie\buildzig\zig-c-simple\c-src/wav.c:46:9
