...
pub const struct_wav_header = extern struct {
...
pub export var wavh: struct_wav_header = @import("std").mem.zeroes(struct_wav_header);
pub export const MIDDLE_C: f32 = @as(f32, @floatCast(256.0));
pub export const sample_rate: c_int = 8000;
pub export const duration_seconds: c_int = 10;
pub export var buffer: [80000]c_short = [1]c_short{0} ** 80000;
pub export const header_length: c_int = @as(c_int, @bitCast(@as(c_uint, @truncate(@sizeOf(struct_wav_header)))));
pub export fn create_wav() c_int {
    ...
    wavh.bytes_per_samp = @as(i16, @bitCast(@as(c_short, @truncate(@divTrunc(@as(c_int, @bitCast(@as(c_int, wavh.bits_per_samp))), @as(c_int, 8)) * @as(c_int, @bitCast(@as(c_int, wavh.num_chans)))))));
    {
        var i: c_int = 0;
        _ = &i;
        while (i < (@as(c_int, 8000) * @as(c_int, 10))) : (i += 1) {
    ...
    wavh.dlength = (@as(c_int, 8000) * @as(c_int, 10)) * @as(c_int, @bitCast(@as(c_int, wavh.bytes_per_samp)));
    ...
    _ = fwrite(@as(?*const anyopaque, @ptrCast(@as([*c]c_short, @ptrCast(@alignCast(&buffer))))), @as(c_ulonglong, @bitCast(@as(c_longlong, @as(c_int, 2)))), @as(c_ulonglong, @bitCast(@as(c_longlong, @as(c_int, 8000) * @as(c_int, 10)))), fp);
    return 0;
}
...
pub const BUFFER_SIZE = @as(c_int, 8000) * @as(c_int, 10);
...
pub const wav_header = struct_wav_header;
